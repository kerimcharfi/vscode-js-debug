...
export class StackFrame implements IFrameElement {
  ...
  constructor(
    ...
    this._thread = thread;
    const script = scriptLocation.scriptId ? thread.getScriptById(scriptLocation.scriptId) : undefined;
  ...
  public equivalentTo(other: unknown) {
    return (
      ...
      other._scriptLocation.scriptId === this._scriptLocation.scriptId
    );
  }
